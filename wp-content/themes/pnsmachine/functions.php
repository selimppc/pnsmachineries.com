...
function custom_login_logo() {
    ...
    echo '<style type="text/css">
        ...
        h1 a { background-image:url(http://localhost/pns/wp-content/uploads/2015/09/PNS_GROUP_LOGO.png) !important; }
...
function my_login_logo_url_title() {
    ...
    return 'PNS Industrial Machineries Ltd.';

}

add_filter( 'login_headertitle', 'my_login_logo_url_title' );

/* --------------login logo change end------------ */